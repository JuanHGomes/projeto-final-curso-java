...
import static com.example.workflow.commons.Camundakeys.IS_EXECUCAO_SUCESSO;
...
public class ExecutarTransacaoDelegate implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        execution.setVariable(TRANSACAO_CAMUNDA_KEY, transacaoExecutada);
        execution.setVariable(IS_EXECUCAO_SUCESSO, transacaoExecutadaComSucesso);
    }
}
