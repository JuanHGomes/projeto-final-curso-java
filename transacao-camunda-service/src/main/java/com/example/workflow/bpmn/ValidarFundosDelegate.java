...
import static com.example.workflow.commons.Camundakeys.IS_FUNDOS_SUFICIENTES_CAMUNDA_KEY;
import static com.example.workflow.commons.Camundakeys.TRANSACAO_CAMUNDA_KEY;
...
public class ValidarFundosDelegate implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        Transacao transacao = (Transacao) execution.getVariable(TRANSACAO_CAMUNDA_KEY);
        ...
        execution.setVariable(TRANSACAO_CAMUNDA_KEY, transacaoValidada);
        execution.setVariable(IS_FUNDOS_SUFICIENTES_CAMUNDA_KEY, fundosSuficientes);
    }
}
